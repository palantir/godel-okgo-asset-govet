...
./godelw exec -- go get github.com/palantir/amalgomate

Output:
go: module github.com/palantir/amalgomate: Get "https://proxy.golang.org/github.com/palantir/amalgomate/@v/list": dial tcp 142.250.188.17:443: i/o timeout
Error: exit status 1
