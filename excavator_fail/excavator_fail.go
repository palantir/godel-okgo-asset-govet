...
./godelw exec -- go get github.com/palantir/okgo

Output:
go: module github.com/palantir/okgo: Get "https://proxy.golang.org/github.com/palantir/okgo/@v/list": dial tcp 142.251.211.177:443: i/o timeout
Error: exit status 1
